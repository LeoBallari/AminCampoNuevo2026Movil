...
def get_siembra_resumen():
    ...
    try:
        ...
        query = """
            ...
            INNER JOIN v2.Cultivos          CUL ON TS.id_cultivo           = CUL.id_cultivo
            INNER JOIN v2.BloquesProduccion BP  ON TS.id_bloque_produccion = BP.id_bloque_produccion
            INNER JOIN v2.Bloques           B   ON BP.id_bloque            = B.id_bloque
            INNER JOIN v2.Entidades         E   ON TS.id_entidad           = E.id_entidad
            INNER JOIN v2.Maquinarias       M1  ON TS.id_maquinaria1       = M1.id_maquinaria
